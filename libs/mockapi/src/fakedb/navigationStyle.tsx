import { LayoutType, MenuStyle, NavStyle, ThemeMode } from '@crema/constants';

export type NavStyleType = { image: string; alias: NavStyle; id: number };
export const navStyles: NavStyleType[] = [
  {
    id: 1,
