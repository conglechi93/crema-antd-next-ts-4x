...
import { LabelObjType, MailObjType } from '@crema/models/apps/Mail';
...
type MailListItemProps = {
  ...
  onChangeCheckedMails: (check: CheckboxChangeEvent, id: number) => void;
  onChangeStarred: (checked: boolean, mail: MailObjType) => void;
  onViewMailDetail: (mail: MailObjType) => void;
  onRemoveItem: (mail: MailObjType) => void;
  onUpdateItem: (mail: MailObjType) => void;
};
